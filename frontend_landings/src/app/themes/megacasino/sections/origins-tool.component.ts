...
/**
 * Orígenes y QR de Mega.
 *
 * Es la herramienta común más lo que Mega necesita: cada QR puede llevar su
 ...
 */
@Component({
  selector: 'app-mega-origins-tool',
  template: `
    <div class="container-fluid p-4 h-100 overflow-auto text-white">

      <div class="d-flex justify-content-between align-items-center mg-4
      ...
      <div class="admin-card">
        <div class="table-responsive">
          <table class="table table-dark table-hover align-middle mg-0">
            <thead>
              <tr>
                <th class="ps-4">ID</th>
                <th>Descripción</th>
                ...
                @if (seleccionado?.id === o.id) {
                  <tr>
                    <td colspan="7" class="p-4">
                      <div class="d-flex justify-content-between align-items-start mg-3">
                        <div>
                      ...
                      <p class="small text-white-50 mt-2 mg-0">
...
export class MegaOriginsToolComponent {
