 ...
 *
 * Mambos usa las mismas claves de redes que Isla, así que GuardarRedes en el
 * backend no necesita ninguna entrada nueva.
 */
@Component({
  selector: 'app-mambos-venue-info',
  ...
  template: `
    <div class="mb-preview">
      ...
      <div class="mb-preview-rejilla">

        <section class="mb-preview-caja">
          <h4>Datos</h4>

          <span class="mb-preview-estado" [class.activa]="activa">
        ...
        <section class="mb-preview-caja">
          ...
          @for (r of redes; track r.clave) {
            <div class="mb-preview-campo">
              ...
              <span class="mb-preview-enlace">{{ social[r.clave] || '—' }}</span>
            </div>
          }
        </section>
        ...
        <section class="mb-preview-caja oscura">
        ...
        <section class="mb-preview-caja">
          ...
          <div class="mb-preview-campo">
            <label>ENLACE</label>
            <span class="mb-preview-enlace">{{ valor('ReclamacionesLink') || '—' }}</span>
          </div>
          ...
          <div class="mb-preview-logo">
            @if (social['reclamacionesImage']) {
              ...
              <span class="mb-preview-vacio">Sin imagen: se usa la del tema</span>
            }
          </div>
        </section>
        ...
        <section class="mb-preview-caja">
          ...
          <div class="mb-preview-logo">
            @if (valor('LogoDark')) {
              ...
              <span class="mb-preview-vacio">Sin logo</span>
            }
          </div>

          <p class="mb-preview-ayuda">Se usa en la cabecera, que es blanca.</p>
        </section>
...
export class MambosVenueInfoComponent {
