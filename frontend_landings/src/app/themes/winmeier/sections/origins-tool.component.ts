...
/**
 * Orígenes y QR de WinMeier.
 *
 * Es la herramienta común más lo que WinMeier necesita: cada QR puede llevar su
 ...
 */
@Component({
  selector: 'app-winmeier-origins-tool',
  template: `
    <div class="container-fluid p-4 h-100 overflow-auto text-white">

      <div class="d-flex justify-content-between align-items-center wm-4
      ...
      <div class="admin-card">
        <div class="table-responsive">
          <table class="table table-dark table-hover align-middle wm-0">
            <thead>
              <tr>
                <th class="ps-4">ID</th>
                <th>Descripción</th>
                ...
                @if (seleccionado?.id === o.id) {
                  <tr>
                    <td colspan="6" class="p-4">
                      <div class="d-flex justify-content-between align-items-start wm-3">
                        <div>
                      ...
                      <p class="small text-white-50 mt-2 wm-0">
...
export class WinMeierOriginsToolComponent {
