namespace casinoweb_api.Application.Common.Interfaces {
    ...
    public interface ISeoFileService {
        ...
        /// <summary>
        /// Regenera el archivo de UNA sede, buscando su nombre por el slug.
        /// Devuelve null si no existe ninguna sede con ese slug.
        ///
        /// Existe para que el controlador no tenga que consultar la base solo
        /// para saber el nombre: esa consulta ya la hace este servicio.
        /// </summary>
        Task<SeoResultado?> RegenerarSedeAsync(string slug, CancellationToken ct = default);
