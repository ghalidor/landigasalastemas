...
const COLORES = ['#9C2525', '#D2A93F', '#9C2525', '#262625'];
 ...
 */
@Component({
  selector: 'app-mega-confeti',
  template: `<canvas #lienzo class="mg-confeti"></canvas>`,
})
export class MegaConfetiComponent implements AfterViewInit, OnDestroy {
