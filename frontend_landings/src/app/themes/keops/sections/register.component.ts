...
/**
 * Registro de Keops: el formulario a la izquierda y la pieza gráfica de la
...
@Component({
  ...
  template: `
    <section class="kp-registro" id="register">
      ...
      <div class="kp-contenido kp-registro-caja" [class.sin-media]="!mostrarMedia">

        <div class="kp-registro-formulario">
          <h2 class="kp-titulo">{{ data.title || '¡Bienvenido a Ganar!' }}</h2>

          @if (data.description) {
            <p class="kp-texto">{{ data.description }}</p>
          }

          <form class="kp-formulario" (ngSubmit)="enviar()">
            <div class="kp-campo">
              <label>Tipo de documento *</label>
              <!--  Mismo desplegable que los otros tres campos. Sin buscador:
                    son tres opciones. -->
              <app-keops-country [options]="tiposDoc" [value]="form.tipoDoc"
            ...
            <div class="kp-campo">
              ...
              <app-keops-country [options]="sexos" [value]="form.sexo"
                                [conBuscador]="false" placeholder="Seleccione"
            ...
            <div class="kp-campo">
              ...
              <app-keops-country [options]="nacionalidades"
                                  [value]="form.nacionalidad"
                                  (valueChange)="form.nacionalidad = $event" />
            </div>

            <div class="kp-campo kp-campo-ancho">
              <label>Celular</label>

              <div class="kp-celular">
                <app-keops-country [options]="codigosPais"
            ...
            <div class="kp-campo-ancho">
              <p class="kp-nota">(*) Campos obligatorios para poder registrarte.</p>
              ...
              <p class="kp-nota mt-3">
                Autorizo el tratamiento de mis datos personales para fines Comerciales por:
                <br />
                <strong class="kp-nota-menuda">(Puede seleccionar más de una opción)</strong>
              </p>

              <div class="kp-canales">
      ...
      @if (isPreview) {
        <aside class="kp-config">
          ...
          <p class="kp-config-estado" [class.activo]="mostrarMedia">
...
export class KeopsRegisterComponent {
  private content = inject(ContentService);

  @Input() data: KeopsRegister = {};
  @Input() venueId = 0;
  @Input() originId = '';
  @Input() slug = '';
  @Input() carpeta = '';
