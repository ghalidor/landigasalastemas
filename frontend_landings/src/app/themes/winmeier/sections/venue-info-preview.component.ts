...
/**
 * Info Sede en el gestor, con el aspecto de WinMeier.
 *
 ...
 *
 * WinMeier usa las mismas claves de redes que Isla, así que GuardarRedes en el
 * backend no necesita ninguna entrada nueva.
 */
@Component({
  selector: 'app-winmeier-venue-info',
  ...
  template: `
    <div class="wm-preview">
      ...
      <div class="wm-preview-rejilla">

        <section class="wm-preview-caja">
          <h4>Datos</h4>

          <span class="wm-preview-estado" [class.activa]="activa">
        ...
        <section class="wm-preview-caja">
          ...
          @for (r of redes; track r.clave) {
            <div class="wm-preview-campo">
              ...
              <span class="wm-preview-enlace">{{ social[r.clave] || '—' }}</span>
            </div>
          }
        </section>
        ...
        <section class="wm-preview-caja oscura">
        ...
        <section class="wm-preview-caja">
          ...
          <div class="wm-preview-campo">
            <label>ENLACE</label>
            <span class="wm-preview-enlace">{{ valor('ReclamacionesLink') || '—' }}</span>
          </div>
        ...
        <section class="wm-preview-caja">
          ...
          <div class="wm-preview-logo">
            @if (valor('LogoDark')) {
              ...
              <span class="wm-preview-vacio">Sin logo</span>
            }
          </div>

          <p class="wm-preview-ayuda">Se usa en la cabecera, que es blanca.</p>
        </section>
        ...
        <section class="wm-preview-caja oscura">
          ...
          <p class="wm-preview-ayuda">Se usa en el pie, que es oscuro.</p>
        </section>
...
export class WinMeierVenueInfoComponent {
