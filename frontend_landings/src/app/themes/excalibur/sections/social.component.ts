 ...
 */
@Component({
  selector: 'app-excalibur-social',
  template: `
    @if (visibles.length) {
      <section class="ex-social" [style.background-image]="fondoCss">
        <div class="ex-social-velo">
          <p>{{ titulo }}</p>

          <div class="ex-social-iconos">
...
export class ExcaliburSocialComponent {
