...
/**
 * Registro de WinMeier: el formulario a la izquierda y la pieza gráfica de la
...
@Component({
  ...
  imports: [FormsModule, RouterLink, WinMeierCountryComponent],
  template: `
    <section class="wm-registro" id="register">

      <div class="wm-contenido wm-registro-caja" [class.sin-media]="!mostrarMedia">

        <div class="wm-registro-formulario">
          ...
          <form class="wm-formulario" (ngSubmit)="enviar()">
            ...
            <div class="wm-campo">
              ...
              <app-winmeier-country [options]="nacionalidades"
                                  [value]="form.nacionalidad"
                                  (valueChange)="form.nacionalidad = $event" />
            </div>

            <div class="wm-campo wm-campo-ancho">
              <label>Celular</label>

              <div class="wm-celular">
                <app-winmeier-country [options]="codigosPais"
            ...
            <div class="wm-campo-ancho">
              <p class="wm-nota">(*) Campos obligatorios para poder registrarte.</p>
              ...
              <p class="wm-nota mt-3">
                Autorizo el tratamiento de mis datos personales para fines Comerciales por:
                <br />
                <strong class="wm-nota-menuda">(Puede seleccionar más de una opción)</strong>
              </p>

              <div class="wm-canales">
      ...
      @if (isPreview) {
        <aside class="wm-config">
          ...
          <p class="wm-config-estado" [class.activo]="mostrarMedia">
...
export class WinMeierRegisterComponent {
  private content = inject(ContentService);

  @Input() data: WinMeierRegister = {};
  @Input() venueId = 0;
  @Input() originId = '';
  @Input() slug = '';
  @Input() carpeta = '';
