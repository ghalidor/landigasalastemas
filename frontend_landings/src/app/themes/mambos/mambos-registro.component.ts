...
/**
 * Formulario suelto de Mambos, para repartir por enlace o QR.
 *
 * Usa el mismo formulario de la landing, así que los campos y los canales de
 * contacto son los que se configuran en el gestor.
 */
@Component({
  selector: 'app-mambos-registro',
  imports: [MambosRegisterComponent],
  template: `
    <div class="mb-registro-solo">
      ...
      @if (logo) {
        <img [src]="logo" [alt]="nombre" class="mb-registro-solo-logo" />
      }

      <app-mambos-register [data]="config" [venueId]="venueId"
...
export class MambosRegistroComponent {
