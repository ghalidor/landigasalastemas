...
/**
 * Formulario suelto de Megacasino, para repartir por enlace o QR.
 *
 * Usa el mismo formulario de la landing, así que los campos y los canales de
 * contacto son los que se configuran en el gestor.
 */
@Component({
  selector: 'app-megacasino-registro',
  imports: [MegaRegisterComponent],
  template: `
    <div class="mg-registro-solo">
      ...
      @if (logo) {
        <img [src]="logo" [alt]="nombre" class="mg-registro-solo-logo" />
      }

      <app-mega-register [data]="config" [venueId]="venueId"
...
export class MegacasinoRegistroComponent {
