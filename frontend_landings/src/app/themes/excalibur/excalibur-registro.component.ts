...
/**
 * Formulario suelto de Excalibur, para repartir por enlace o QR.
 *
 * Usa el mismo formulario de la landing, así que los campos y los canales de
 * contacto son los que se configuran en el gestor.
 */
@Component({
  selector: 'app-excalibur-registro',
  imports: [ExcaliburRegisterComponent],
  template: `
    <div class="ex-registro-solo">
      ...
      @if (logo) {
        <img [src]="logo" [alt]="nombre" class="ex-registro-solo-logo" />
      }

      <app-excalibur-register [data]="config" [venueId]="venueId"
...
export class ExcaliburRegistroComponent {
