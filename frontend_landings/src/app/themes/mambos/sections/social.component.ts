 ...
 */
@Component({
  selector: 'app-mambos-social',
  template: `
    @if (visibles.length) {
      <section class="mb-social" [style.background-image]="fondoCss">
        <div class="mb-social-velo">
          <p>{{ titulo }}</p>

          <div class="mb-social-iconos">
...
export class MambosSocialComponent {
  @Input() social: Record<string, string> = {};
  @Input() carpeta = '';

  /** Fondo de la franja. El original usa events/bgClub.jpg. */
  @Input() fondo = '';
