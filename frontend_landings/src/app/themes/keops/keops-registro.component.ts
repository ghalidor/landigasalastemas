...
/**
 * Formulario suelto de Keops, para repartir por enlace o QR.
 *
 * Usa el mismo formulario de la landing, así que los campos y los canales de
 * contacto son los que se configuran en el gestor.
 */
@Component({
  selector: 'app-keops-registro',
  imports: [KeopsRegisterComponent],
  template: `
    <div class="kp-registro-solo">
      ...
      @if (logo) {
        <img [src]="logo" [alt]="nombre" class="kp-registro-solo-logo" />
      }

      <app-keops-register [data]="config" [venueId]="venueId"
...
export class KeopsRegistroComponent {
