...
export interface ExcaliburFlotante {
...
export const DESTINOS = [
  ...
  { ancla: 'club', nombre: 'Excalibur Club' },
 ...
 */
@Component({
  selector: 'app-excalibur-btn-club',
  ...
  template: `
    ...
    @if (isPreview) {
      <aside class="ex-config">
        ...
        <p class="ex-config-estado activo">
...
export class ExcaliburBtnClubComponent implements OnInit {
  private doc = inject(DOCUMENT);

  @Input() data: ExcaliburFlotante = {};
  @Input() carpeta = '';
