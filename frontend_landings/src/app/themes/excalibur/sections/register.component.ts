...
/**
 * Registro de Excalibur: el formulario a la izquierda y la pieza gráfica de la
...
@Component({
  ...
  template: `
    <section class="ex-registro" id="register">
      ...
      <div class="ex-contenido ex-registro-caja" [class.sin-media]="!mostrarMedia">

        <div class="ex-registro-formulario">
          <h2 class="ex-titulo">{{ data.title || '¡Bienvenido a Ganar!' }}</h2>

          @if (data.description) {
            <p class="ex-texto">{{ data.description }}</p>
          }

          <form class="ex-formulario" (ngSubmit)="enviar()">
            <div class="ex-campo">
              <label>Tipo de documento *</label>
              <!--  Mismo desplegable que los otros tres campos. Sin buscador:
                    son tres opciones. -->
              <app-excalibur-country [options]="tiposDoc" [value]="form.tipoDoc"
            ...
            <div class="ex-campo">
              ...
              <app-excalibur-country [options]="sexos" [value]="form.sexo"
                                [conBuscador]="false" placeholder="Seleccione"
            ...
            <div class="ex-campo">
              ...
              <app-excalibur-country [options]="nacionalidades"
                                  [value]="form.nacionalidad"
                                  (valueChange)="form.nacionalidad = $event" />
            </div>

            <div class="ex-campo ex-campo-ancho">
              <label>Celular</label>

              <div class="ex-celular">
                <app-excalibur-country [options]="codigosPais"
            ...
            <div class="ex-campo-ancho">
              ...
              <p class="ex-nota mt-3">
                Autorizo el tratamiento de mis datos personales para fines Comerciales por:
                <br />
                <strong class="ex-nota-menuda">(Puede seleccionar más de una opción)</strong>
              </p>

              <div class="ex-canales">
      ...
      @if (isPreview) {
        <aside class="ex-config">
          ...
          <p class="ex-config-estado" [class.activo]="visible">
          ...
          <p class="ex-config-estado" [class.activo]="mostrarMedia">
...
export class ExcaliburRegisterComponent {
  private content = inject(ContentService);

  @Input() data: ExcaliburRegister = {};
  @Input() venueId = 0;
  @Input() originId = '';
  @Input() slug = '';
  @Input() carpeta = '';
