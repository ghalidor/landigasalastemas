...
/**
 * Orígenes y QR de Mambos.
 *
 * Es la herramienta común más lo que Mambos necesita: cada QR puede llevar su
 ...
 */
@Component({
  selector: 'app-mambos-origins-tool',
  template: `
...
export class MambosOriginsToolComponent {
